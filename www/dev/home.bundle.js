...
var map = {
	...
	"./core/browser/eventbus": "./dist/browser/core/browser/eventbus/index.js",
	"./core/browser/eventbus/": "./dist/browser/core/browser/eventbus/index.js",
	...
	"./core/browser/eventbus/factory": "./dist/browser/core/browser/eventbus/factory/index.js",
	"./core/browser/eventbus/factory/": "./dist/browser/core/browser/eventbus/factory/index.js",
	"./core/browser/eventbus/factory/index": "./dist/browser/core/browser/eventbus/factory/index.js",
	"./core/browser/eventbus/factory/index.js": "./dist/browser/core/browser/eventbus/factory/index.js",
	"./core/browser/eventbus/factory/locator": "./dist/browser/core/browser/eventbus/factory/locator.js",
	"./core/browser/eventbus/factory/locator.js": "./dist/browser/core/browser/eventbus/factory/locator.js",
	"./core/browser/eventbus/index": "./dist/browser/core/browser/eventbus/index.js",
	"./core/browser/eventbus/index.js": "./dist/browser/core/browser/eventbus/index.js",
	...
	"./core/common/bus/metrics": "./dist/browser/core/common/bus/metrics/index.js",
	"./core/common/bus/metrics/": "./dist/browser/core/common/bus/metrics/index.js",
	"./core/common/bus/metrics/index": "./dist/browser/core/common/bus/metrics/index.js",
	"./core/common/bus/metrics/index.js": "./dist/browser/core/common/bus/metrics/index.js",
	"./core/common/bus/metrics/locator": "./dist/browser/core/common/bus/metrics/locator.js",
	"./core/common/bus/metrics/locator.js": "./dist/browser/core/common/bus/metrics/locator.js",
...
var domIsReady = __webpack_require__(/*! ../dom-ready */ "./dist/browser/core/browser/dom-ready/index.js"),
    CoreFactory = __webpack_require__(/*! ../factory */ "./dist/browser/core/browser/factory.js");

var Application = function Application(components) {
  var _this = this;
  ...
  var domReadyStart = window.performance.now();
  domIsReady(function () {
    var domReadyEnd = window.performance.now(),
    ...
    _this.core.load().then(function () {
      ...
      _this.core.locate('core/bootstrap').bootstrap().then(function () {
        var bootstrapEnd = window.performance.now(),
            bus = _this.core.locator.locate('core/bus');
        ...
        bus.emit({
          ...
          data: {
            metrics: {
              ...
              totalcomponents: _this.components.length,
...
var dirname =  false || 'core/browser/console';
module.exports = {
  'core': {
    // 'bootstrap' :
    // {
...
function (_CoreConsole) {
  ...
  function BrowserConsole(args) {
    ...
    _this.background = _this.config.background;
    return _this;
  }
...
var isIE = __webpack_require__(/*! ../is-ie */ "./dist/browser/core/browser/is-ie/index.js");
  ...
  if (callback && typeof callback === 'function') {
    if (isIE()) {
      document.attachEvent('onreadystatechange', function () {
        if (document.readyState === 'complete') return callback(callbackArgs);
      });
    } else {
...
function () {
  function EventbusBootstrap(_ref) {
    var configuration = _ref.configuration,
        eventBusFactory = _ref.eventBusFactory,
...
module.exports = {
  'core': {
    ...
    'locator': {
      ...
      'core/eventbus/factory': "".concat(dirname, "/factory")
    },
    'eventbus': {
      'options': {
        'console': {
...
/***/ "./dist/browser/core/browser/eventbus/factory/index.js":
/*!*************************************************************!*\
  !*** ./dist/browser/core/browser/eventbus/factory/index.js ***!
  \*************************************************************/
/*! no static exports found */
...
var Eventbus = __webpack_require__(/*! .. */ "./dist/browser/core/browser/eventbus/index.js");

var EventbusFactory =
/*#__PURE__*/
function () {
  function EventbusFactory(_ref) {
    ...
    _classCallCheck(this, EventbusFactory);
  ...
  _createClass(EventbusFactory, [{
    ...
    value: function create(_ref2) {
      var consoleOptions = _ref2.consoleOptions;
      return new Eventbus({
        id: 'eventbus',
...
/***/ "./dist/browser/core/browser/eventbus/factory/locator.js":
/*!***************************************************************!*\
  !*** ./dist/browser/core/browser/eventbus/factory/locator.js ***!
  \***************************************************************/
/*! no static exports found */
...
var EventbusFactory = __webpack_require__(/*! . */ "./dist/browser/core/browser/eventbus/factory/index.js");

var EventbusFactoryLocator =
/*#__PURE__*/
function () {
  function EventbusFactoryLocator(locator) {
    _classCallCheck(this, EventbusFactoryLocator);
  ...
  _createClass(EventbusFactoryLocator, [{
    key: "locate",
    value: function locate() {
...
/***/ "./dist/browser/core/browser/eventbus/index.js":
/*!*****************************************************!*\
  !*** ./dist/browser/core/browser/eventbus/index.js ***!
  \*****************************************************/
/*! no static exports found */
...
var BusChannel = __webpack_require__(/*! core/common/channel */ "./dist/browser/core/common/channel/index.js");

var Eventbus =
/*#__PURE__*/
function (_BusChannel) {
  _inherits(Eventbus, _BusChannel);
  ...
  _createClass(Eventbus, [{
    ...
    value: function emit(name, data) {
      _get(_getPrototypeOf(Eventbus.prototype), "emit", this).call(this, {
        name: name,
        data: data
      });
    }
    ...
    value: function on(event, observer) {
      _get(_getPrototypeOf(Eventbus.prototype), "on", this).call(this, {
        event: event,
        observer: observer
      });
    }
    ...
    key: "once",
    value: function once(event, observer) {
      _get(_getPrototypeOf(Eventbus.prototype), "once", this).call(this, {
        event: event,
        observer: observer
      });
    }
...
module.exports = {
  'core': {
    ...
    'locator': {
      ...
      'core/bus/metrics': "".concat(dirname, "/metrics")
    }
  }
};
...
function () {
  ...
  _createClass(Bus, [{
    ...
    key: "onAll",
    value: function onAll(_ref5) {
      var channelId = _ref5.channelId,
          observer = _ref5.observer;
      this.getChannel(channelId).onAll(observer);
    }
  }, {
    key: "removeListener",
...
/***/ "./dist/browser/core/common/bus/metrics/index.js":
/*!*******************************************************!*\
  !*** ./dist/browser/core/common/bus/metrics/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
/*#__PURE__*/
function () {
  function MetricsObserver(logConsole) {
    _classCallCheck(this, MetricsObserver);

    this.logConsole = logConsole;
  }

  _createClass(MetricsObserver, [{
    key: "observe",
...
/***/ "./dist/browser/core/common/bus/metrics/locator.js":
/*!*********************************************************!*\
  !*** ./dist/browser/core/common/bus/metrics/locator.js ***!
  \*********************************************************/
/*! no static exports found */
...
var MetricsObserver = __webpack_require__(/*! . */ "./dist/browser/core/common/bus/metrics/index.js");

var MetricsObserverLocator =
/*#__PURE__*/
function () {
  function MetricsObserverLocator(locator) {
    _classCallCheck(this, MetricsObserverLocator);

    this.locator = locator;
  }

  _createClass(MetricsObserverLocator, [{
    key: "locate",
    value: function locate() {
...
function () {
  function Console(_ref) {
    ...
    this.config = config;
    this.console = console;
    this.util.inspect.styles = _objectSpread({}, this.util.inspect.styles, {}, this.getInspectStyles());
  }
  ...
  _createClass(Console, [{
    ...
    key: "getInspectStyles",
    value: function getInspectStyles() {
      return this.config.inspect && this.config.inspect.options ? this.config.inspect.options : {};
    }
  }, {
    key: "shortenString",
